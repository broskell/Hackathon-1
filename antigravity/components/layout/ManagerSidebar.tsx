...
const navItems = [
  ...
  { href: '/manager/insights', label: 'AI Insights', icon: Sparkles },
  { href: '/manager/audit', label: 'Audit Trail', icon: Shield },
]
...
export function ManagerSidebar({ mobileOnly = false }: { mobileOnly?: boolean }) {
  if (mobileOnly) {
    return (
      <Sheet>
        <SheetTrigger
